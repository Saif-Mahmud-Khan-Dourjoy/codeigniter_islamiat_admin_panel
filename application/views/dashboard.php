	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href=""><span>ILM</span></a>
					...
					<ul class="nav pull-right">
						...
						<li class="dropdown hidden-phone">
							...
							<ul class="dropdown-menu messages">
                                ...
                                <li>
                                    <a href="#">
										<span class="avatar"><img src="public/img/avatar2.jpg" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Megan Abott
										     </span>
                                ...
                                <li>
                                    <a href="#">
										<span class="avatar"><img src="public/img/avatar3.jpg" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Kate Ross
										     </span>
								...
								<li>
                                    <a href="#">
										<span class="avatar"><img src="public/img/avatar4.jpg" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Julie Blank
										     </span>
						...
						<li class="dropdown">
							<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
								<i class="halflings-icon white user"></i> Dourjoy Khan
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							<a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet"> Template Management</span></a>
							<ul >
								<li >
									<a class="submenu" href="<?php echo base_url();?>add_temp"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Template </span></a>
               
								</li>

								<li><a class="submenu" href="<?php echo base_url();?>show_temp"><i class="icon-file-alt"></i><span class="hidden-tablet"> Edit Template </span></a></li>
								<!-- <li><a class="submenu" href="<?php echo base_url();?>show_temp"><i class="icon-file-alt"></i><span class="hidden-tablet"> Delete Template </span></a></li> -->
							</ul>	
						</li>
						<li>
							<a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet"> Content Management</span></a>
							<ul>
								<li>
									<a class="submenu" href="<?php echo base_url();?>show_temp_cont"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Content </span></a>
             
								</li>

								<li><a class="submenu" href="<?php echo base_url();?>content/show_all"><i class="icon-file-alt"></i><span class="hidden-tablet"> Edit Content </span></a></li>
								<!-- <li><a class="submenu" href="submenu3.html"><i class="icon-file-alt"></i><span class="hidden-tablet"> Delete Content </span></a></li> -->
							</ul>	
						</li>
							<li>
							<a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet"> Menu Management</span></a>
							<ul >
								<li >
									<a class="submenu" href="<?php echo base_url();?>add_menu"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Menu </span></a>
